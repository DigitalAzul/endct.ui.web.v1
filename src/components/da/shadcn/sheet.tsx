...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn("flex flex-col gap-1.5 Zp-4 h-0", className)}
            {...props}
        />
    )
}
...
function SheetTitle({
    ...
    return (
        <SheetPrimitive.Title
            ...
            className={cn("text-foreground font-semibold h-0", className)}
            {...props}
        />
    )
}
...
function SheetDescription({
    ...
    return (
        <SheetPrimitive.Description
            ...
            className={cn("text-muted-foreground text-sm h-0", className)}
            {...props}
        />
    )
}
