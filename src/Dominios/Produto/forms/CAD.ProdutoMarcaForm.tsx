...
import { CAD_MARCA } from '@/infra/graphql/mutations/DProduto/Produto/mutation_cad_narca';
...
export function CADProdutoMarcaForm(props: Tprops) {

    let errorGql: TTopoFormErros = { erro: false, msg: '' }


    const [ExecMutation, { data, loading, error }] = useMutation(CAD_MARCA, {
    ...
    const _onSubmit: SubmitHandler<FormProps> = (data: FormProps) => {
        ...
        ExecMutation({ variables: { inserirMarcaProdutoDto: { ...dto } } })
    }
