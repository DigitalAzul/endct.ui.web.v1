...
import { ProdutoGrupoForm } from "../forms/ProdutoGrupoForm";
...
export function TableFormGrupo() {
    ...
    const [obtGruposProduto, { loading, error, data }] = useLazyQuery<{ Produto_Grupos: Entity[] }>(OBTER_PRODUTO_GRUPOS);
