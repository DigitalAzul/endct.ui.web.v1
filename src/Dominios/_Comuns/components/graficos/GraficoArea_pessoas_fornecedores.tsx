...
export function GraficoAreaPessoasFornecedores() {
        ...
        <Card className="pt-0">
            <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
                <div className="grid flex-1 gap-1">
                    <CardTitle className="text-3xl font-light">FORNECEDORES DA CURVA ABC</CardTitle>
                    <CardDescription>
                        Mostranto a desempenho de fornecedores da Curva ABC
                    </CardDescription>
                </div>
