...
import { CADPessoaForm } from "../Forms/CAD.PessoaForm";
import { PessoaEntity } from "../Types/PessoaEntity";
import { GrupoAcoesPessoa } from "./GrupoDeAcoes/GrupoAcoesPessoa";
...
type Entity = z.infer<typeof PessoaEntity>;


export function TableFormPessoa() {
    ...
    return (
        ...
        <div className="flex flex-col pb-10">
            ...
            <div className="flex w-full items-center p-10">
                <GrupoAcoesPessoa callBackFunction={(a) => callbackGrupoAcoes(a)} trabalhando={loading} />
            </div>
