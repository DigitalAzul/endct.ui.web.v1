...
export type InsProdutoEntraDto = {
  ...
  grupo_produto_id: Scalars['String']['input'];
  ...
  sub_grupo_produto_id: Scalars['String']['input'];
  temp_max_conservacao: Scalars['String']['input'];
  tipo_produto: Scalars['String']['input'];
};

export type InsProdutoGrupoEntradaDto = {
  AlteracaoDataHora: Scalars['String']['input'];
  AlteracaoUsuario: Scalars['String']['input'];
  CodigoGrupoProduto: Scalars['String']['input'];
  Descricao: Scalars['String']['input'];
  Imagem: Scalars['String']['input'];
};
...
export type InsProdutoGrupoRespostaDto = {
  ...
  atualizado_em?: Maybe<Scalars['DateTime']['output']>;
  atualizado_por_id?: Maybe<Scalars['String']['output']>;
  criado_em: Scalars['DateTime']['output'];
  criado_por_id: Scalars['String']['output'];
...
export type UpdatePessoaInputDto = {
  ...
  atualizado_em?: InputMaybe<Scalars['DateTime']['input']>;
  atualizado_por_id?: InputMaybe<Scalars['String']['input']>;
  cnae?: InputMaybe<Scalars['String']['input']>;
  cnpj_cpf?: InputMaybe<Scalars['String']['input']>;
  criado_em?: InputMaybe<Scalars['DateTime']['input']>;
  criado_por_id?: InputMaybe<Scalars['String']['input']>;
...
export type UpdateProdutoInput = {
  ...
  grupo_produto_id?: InputMaybe<Scalars['String']['input']>;
  id: Scalars['Int']['input'];
  ...
  sub_grupo_produto_id?: InputMaybe<Scalars['String']['input']>;
...
export type TodasPessoasQueryVariables = Exact<{ [key: string]: never; }>;


export type TodasPessoasQuery = { __typename?: 'Query', pessoas: Array<{ __typename?: 'PessoaDto', _id?: string | null, nome_fantasia: string }> };
...
export const TodasPessoasDocument = new TypedDocumentString(`
    query todasPessoas {
  pessoas {
    _id
    nome_fantasia
    ...
    `) as unknown as TypedDocumentString<TodasPessoasQuery, TodasPessoasQueryVariables>;